...
You can import the JavaScript from `franken-ui`, which you installed earlier, into your `app-defer.js` file.
...
Inside your <head> tag you should `defer` script.
```html
<script src="/assets/app-defer.js" defer></script>
```
